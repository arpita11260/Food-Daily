...
const Faq = () => {
    return (
        <div>
            ...
            <h1 className="text-center text-info font-margin heading">Frequently Asked <span className="orange-color">Questions</span></h1>
            <div className="row d-flex align-items-center">
                <div className="col-lg-6">
                    <img src="https://static.toiimg.com/thumb/msid-81923053,width-1200,height-900,resizemode-4/.jpg" className=" w-75 m-2 img-fluid border border-3 border-primary rounded-pill p-2" alt=""/>
                </div>
